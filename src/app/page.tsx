                  ...
                  <div className="space-y-3">
                    {result.downloadLinks.map((link, index) => (
                      <a
                        ...
                        onClick={() => {
                          setDownloadToast(
                            `Preparing your ${link.quality} download... This may take a moment for large videos. Your file will download automatically.`
                          );
                          window.setTimeout(() => setDownloadToast(""), 12000);
                        }}
                        className="flex items-center justify-between p-4 bg-green-50 hover:bg-green-100 border border-green-200 rounded-xl transition-all duration-200 group"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">
                              {link.format.toUpperCase()} {link.size !== "N/A" ? `• ${link.size}` : ""}
                            </p>
                          </div>
                        </div>
